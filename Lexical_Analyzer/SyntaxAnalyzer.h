...
public:
	...
	bool firstHasEbsilon(vector<string> firstOfNext);
    vector<string> getFollowOf(string nonTerminal);
	map<string,int> indexOfTerminal;
	map<string,int> indexOfNonTerminal;
	vector<Symbol> **parsingTable;
	void generateIndexMaps();
	void generateParsingTable();
	void printVectorOfSymbols(vector<Symbol> toBePrinted);
